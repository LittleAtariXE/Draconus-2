...
class Shortcuts:
    def __init__(self, builder: object, library: object):
        ...
        self.shortucts = {
            ...
            "MyShellcode" : os.path.join(self.library.DIR_LIB_ITEM_PAYLOADS, "my_shellcode.data"),
            "PyToExe" : os.path.join(self.library.DIR_LIB_ITEM_WORMS, "py_to_exe.data"),
            "DuckTalesText" : os.path.join(self.library.DIR_LIB_ITEM_FOOD, "duck_tales_text.data")
        }
