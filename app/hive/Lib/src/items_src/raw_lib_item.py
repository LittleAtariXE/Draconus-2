...
class RawLibItem:
    def __init__(self, raw_info_item: object):
        ...
        # '_SHELLCODE' - A variable contain shellcode.
        # ex: Var##EXEC_SHOW##gui##[description]##optional[type]
        self.Var = {}

        ## Variable Options ##
        # VarOpt##[var_name]##[opt_name]##[opt_value]##optional[info]
        # OPTIONS:
        #   - HIDE : True / False   - Hides a variable from display.
        # ex: VarOpt##en_key##HIDE##True##hide variable
        self.VarOpt = {}
        ...
        ######################### CODE, BUILD CODE OPTIONS #########################################
        # Specifies whether the module code will not be added to the main code.
        # codeOFF##True
        self.codeOFF = False
