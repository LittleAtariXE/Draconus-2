...
class Queen:
    def __init__(self, builder_object: object):
        ...
        self.DIR_LINKS = self.conf.DIR_SHORTCUTS
        ...
        ### Linking a new directory for worms
        if not os.path.exists(self.conf.DIR_HIVE_OUT_RAW):
            os.symlink(self.conf.DIR_HIVE_OUT, self.conf.DIR_HIVE_OUT_RAW)
    ...
    def updatePIP(self) -> None:
        self.master_compiler.updatePIP()
